...
SECRET_KEY = 'django-insecure-r04%%aw9d8!v@(ysnk6s4gb!my)q%y(_zw_+mc726*dij*e787'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'fmarinho.pythonanywhere.com'
]
...
AXES_COOLOFF_TIME = 0.10 # Tempo (em horas) que o usuário precisa esperar para tentar novamente